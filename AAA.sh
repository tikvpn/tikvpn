...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%40s%s%-12s\n' "TIK VPN  SSHPLUS MANAGER" ; tput sgr0
echo -e "\033[1;31m════════════════════════════════════════════════════\033[0m"
echo ""
...
echo ""
echo -e "\033[1;31m≠×≠×≠×≠×≠×≠×≠×≠×[\033[1;33m • \033[1;32mBY TIK VPN\033[1;33m •\033[1;31m ]≠×≠×≠×≠×≠×≠×≠×≠×\033[0m"
echo ""
...
clear
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%35s%s%-18y\n' " AGUARDE A INSTALAÇÃO" ; tput sgr0
echo ""
echo ""
